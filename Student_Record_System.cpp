...
// Menu -> Add the info about student 1)Name, 2)Scholar no. , 3)Branch, 4)Current year, 5) Current sem, {6) Last sem sgpa or cgpa} Edit anything all four, Search about student with all four (if possible otherwise only name or scholar no.), Update all four (the scholar no. will always be unique to every student), Delete the info about a student, Show or Print the table of Student Record
